package systems.ajax.motrechko.airguardian.core.infrastructure.configuration.kafka
...
open class GeneralKafkaConfiguration(
    ...
    protected fun producerProperties(customProperties: MutableMap<String, Any> = mutableMapOf())
